...
//
// On Sun Nov 24 09:35:17 IST 2024
//
//
// Ports:
// Name                         I/O  size props
...
module mkMac(CLK,
  ...
  wire [32 : 0] x_sum_difference__h6029;
  wire [31 : 0] IF_adder_subractor_rg_sub_THEN_theResult___snd_ETC__q1,
		_theResult___snd__h7122,
		_theResult___snd__h8129,
		x__h15618;
  ...
  wire IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d171,
       got_a_97_AND_got_b_98_99_AND_got_c_00_01_AND_N_ETC___d304,
       x_carry_burrow__h6028;
  ...
  // actionvalue method mac_op
  assign mac_op = adder_subractor_rg_op[31:0] ;
  assign RDY_mac_op =
	     got_a && got_b && got_c && got_mul && adder_subractor_opReady ;
  assign CAN_FIRE_mac_op = RDY_mac_op ;
  ...
  assign WILL_FIRE_RL_adder_subractor_rl_sum =
	     CAN_FIRE_RL_adder_subractor_rl_sum ;
  ...
  // register adder_subractor_opReady
  assign adder_subractor_opReady$D_IN = !EN_mac_op ;
  assign adder_subractor_opReady$EN =
	     EN_mac_op || WILL_FIRE_RL_adder_subractor_rl_sum ;
  ...
  assign adder_subractor_rg_op$D_IN =
	     { x_carry_burrow__h6028, x_sum_difference__h6029 } ;
  assign adder_subractor_rg_op$EN = CAN_FIRE_RL_adder_subractor_rl_sum ;
  ...
  // register got_mul
  assign got_mul$D_IN = !EN_mac_op ;
  assign got_mul$EN = EN_mac_op || WILL_FIRE_RL_rl_add ;
  ...
  assign IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d274 =
	     adder_subractor_rg_sub ?
	       { _theResult___snd__h7122[31:2],
		 adder_subractor_fas_1$difference } :
	       { _theResult___snd__h8129[31:2], adder_subractor_fas_1$sum } ;
  ...
  assign IF_adder_subractor_rg_sub_THEN_theResult___snd_ETC__q1 =
	     adder_subractor_rg_sub ?
	       _theResult___snd__h7122 :
	       _theResult___snd__h8129 ;
  assign _theResult___snd__h7122 =
	     adder_subractor_fas_0$difference ? 32'd1 : 32'd0 ;
  assign _theResult___snd__h8129 = adder_subractor_fas_0$sum ? 32'd1 : 32'd0 ;
  assign got_a_97_AND_got_b_98_99_AND_got_c_00_01_AND_N_ETC___d304 =
  ...
  begin
	...
	got_mul <= `BSV_ASSIGNMENT_DELAY 1'd0;
	...
	if (got_mul$EN) got_mul <= `BSV_ASSIGNMENT_DELAY got_mul$D_IN;
