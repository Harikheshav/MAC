...
module mkMultiplier(CLK,
  ...
  // register adder_subractor_opReady
  reg adder_subractor_opReady;
  wire adder_subractor_opReady$D_IN, adder_subractor_opReady$EN;
  ...
  // register adder_subractor_rg_op
  reg [33 : 0] adder_subractor_rg_op;
  wire [33 : 0] adder_subractor_rg_op$D_IN;
  wire adder_subractor_rg_op$EN;
  ...
  // register counter
  reg [6 : 0] counter;
  wire [6 : 0] counter$D_IN;
  wire counter$EN;

  // register got_ip
  reg got_ip;
  wire got_ip$D_IN, got_ip$EN;

  // register got_partop
  reg got_partop;
  wire got_partop$D_IN, got_partop$EN;

  // register rg_ip
  reg [63 : 0] rg_ip;
  wire [63 : 0] rg_ip$D_IN;
  wire rg_ip$EN;
  ...
  wire CAN_FIRE_RL_adder_subractor_rl_sum,
       ...
       WILL_FIRE_RL_rl_ip,
       WILL_FIRE_RL_rl_prod,
       WILL_FIRE_inp,
       WILL_FIRE_op;

  // inputs to muxes for submodule ports
  wire [63 : 0] MUX_rg_ip$write_1__VAL_1, MUX_rg_ip$write_1__VAL_2;
  wire [6 : 0] MUX_counter$write_1__VAL_1;
  wire MUX_adder_subractor_got_ip$write_1__SEL_1,
       MUX_adder_subractor_got_ip$write_1__SEL_2;

  // remaining internal signals
  wire [32 : 0] x_sum_difference__h6169;
  wire [31 : 0] IF_adder_subractor_rg_sub_THEN_theResult___snd_ETC__q1,
		_theResult___snd__h7262,
		_theResult___snd__h8269,
		x__h15758,
		x__h23966,
		x__h23973,
		x__h24081,
		x__h24088;
  wire [30 : 0] IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d274;
  wire [29 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d292;
  wire [27 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d291;
  wire [25 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d290;
  wire [23 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d289;
  wire [21 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d288;
  wire [19 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d287;
  wire [17 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d286;
  wire [15 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d285;
  wire [13 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d284;
  wire [11 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d283;
  wire [9 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d282;
  wire [7 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d281;
  wire [5 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d280;
  wire [3 : 0] IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d279;
  wire [1 : 0] IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d278;
  wire IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d171,
       x_carry_burrow__h6168;

  // action method inp
  assign RDY_inp = !got_ip ;
  assign CAN_FIRE_inp = !got_ip ;
  assign WILL_FIRE_inp = EN_inp ;

  // actionvalue method op
  assign op = rg_op ;
  assign RDY_op = counter == 7'd32 && got_ip && !got_partop ;
  assign CAN_FIRE_op = counter == 7'd32 && got_ip && !got_partop ;
  assign WILL_FIRE_op = EN_op ;
  ...
  // rule RL_rl_prod
  assign CAN_FIRE_RL_rl_prod =
	     (!rg_ip[32] || adder_subractor_opReady) && counter != 7'd32 &&
	     got_ip &&
	     got_partop ;
  assign WILL_FIRE_RL_rl_prod = CAN_FIRE_RL_rl_prod ;

  // rule RL_adder_subractor_rl_sum
  assign CAN_FIRE_RL_adder_subractor_rl_sum =
	     adder_subractor_got_ip && !adder_subractor_opReady ;
  assign WILL_FIRE_RL_adder_subractor_rl_sum =
	     CAN_FIRE_RL_adder_subractor_rl_sum && !WILL_FIRE_RL_rl_prod ;

  // rule RL_rl_ip
  assign CAN_FIRE_RL_rl_ip =
	     (!rg_ip[32] || !adder_subractor_got_ip) && counter != 7'd32 &&
	     got_ip &&
	     !got_partop ;
  assign WILL_FIRE_RL_rl_ip = CAN_FIRE_RL_rl_ip ;

  // inputs to muxes for submodule ports
  assign MUX_adder_subractor_got_ip$write_1__SEL_1 =
	     WILL_FIRE_RL_rl_prod && rg_ip[32] ;
  assign MUX_adder_subractor_got_ip$write_1__SEL_2 =
	     WILL_FIRE_RL_rl_ip && rg_ip[32] ;
  assign MUX_counter$write_1__VAL_1 = counter + 7'd1 ;
  assign MUX_rg_ip$write_1__VAL_1 = { x__h23966, x__h23973 } ;
  assign MUX_rg_ip$write_1__VAL_2 = { x__h24081, x__h24088 } ;

  // register adder_subractor_got_ip
  assign adder_subractor_got_ip$D_IN =
	     !MUX_adder_subractor_got_ip$write_1__SEL_1 ;
  assign adder_subractor_got_ip$EN =
	     WILL_FIRE_RL_rl_prod && rg_ip[32] ||
	     WILL_FIRE_RL_rl_ip && rg_ip[32] ;

  // register adder_subractor_opReady
  assign adder_subractor_opReady$D_IN =
	     !MUX_adder_subractor_got_ip$write_1__SEL_1 ;
  assign adder_subractor_opReady$EN =
	     WILL_FIRE_RL_rl_prod && rg_ip[32] ||
	     WILL_FIRE_RL_adder_subractor_rl_sum ;

  // register adder_subractor_rg_ip
  assign adder_subractor_rg_ip$D_IN = { rg_op, rg_ip[31:0] } ;
  assign adder_subractor_rg_ip$EN =
	     MUX_adder_subractor_got_ip$write_1__SEL_2 ;

  // register adder_subractor_rg_op
  assign adder_subractor_rg_op$D_IN =
	     { x_carry_burrow__h6168, x_sum_difference__h6169 } ;
  assign adder_subractor_rg_op$EN = WILL_FIRE_RL_adder_subractor_rl_sum ;
  ...
  // register counter
  assign counter$D_IN =
	     WILL_FIRE_RL_rl_prod ? MUX_counter$write_1__VAL_1 : 7'd0 ;
  assign counter$EN = WILL_FIRE_RL_rl_prod || EN_inp || EN_op ;

  // register got_ip
  assign got_ip$D_IN = !EN_op ;
  assign got_ip$EN = EN_op || EN_inp ;

  // register got_partop
  assign got_partop$D_IN = !WILL_FIRE_RL_rl_prod ;
  assign got_partop$EN = WILL_FIRE_RL_rl_prod || WILL_FIRE_RL_rl_ip ;

  // register rg_ip
  assign rg_ip$D_IN =
	     WILL_FIRE_RL_rl_prod ?
	       MUX_rg_ip$write_1__VAL_1 :
	       MUX_rg_ip$write_1__VAL_2 ;
  assign rg_ip$EN = WILL_FIRE_RL_rl_prod || EN_inp ;

  // register rg_op
  assign rg_op$D_IN =
	     MUX_adder_subractor_got_ip$write_1__SEL_1 ?
	       adder_subractor_rg_op[31:0] :
	       32'd0 ;
  assign rg_op$EN = WILL_FIRE_RL_rl_prod && rg_ip[32] || EN_inp ;
  ...
  // remaining internal signals
  assign IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d274 =
	     adder_subractor_rg_sub ?
	       { _theResult___snd__h7262[31:2],
		 adder_subractor_fas_1$difference } :
	       { _theResult___snd__h8269[31:2], adder_subractor_fas_1$sum } ;
  assign IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d278 =
	     { IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d274[0],
	       IF_adder_subractor_rg_sub_THEN_theResult___snd_ETC__q1[0] } ;
  assign IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d171 =
	     adder_subractor_rg_sub ?
  ...
  assign IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d279 =
		 ...
		 adder_subractor_fas_2$difference :
		 adder_subractor_fas_2$sum,
	       IF_adder_subractor_rg_sub_THEN_IF_adder_subrac_ETC___d278 } ;
  ...
  assign IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d290 =
	     { adder_subractor_rg_sub ?
		 adder_subractor_fas_25$difference :
		 adder_subractor_fas_25$sum,
	       adder_subractor_rg_sub ?
  ...
  assign IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d291 =
	     { adder_subractor_rg_sub ?
		 adder_subractor_fas_27$difference :
		 adder_subractor_fas_27$sum,
	       adder_subractor_rg_sub ?
		 adder_subractor_fas_26$difference :
		 adder_subractor_fas_26$sum,
	       IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d290 } ;
  assign IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d292 =
	     { adder_subractor_rg_sub ?
		 adder_subractor_fas_29$difference :
		 adder_subractor_fas_29$sum,
	       adder_subractor_rg_sub ?
		 adder_subractor_fas_28$difference :
		 adder_subractor_fas_28$sum,
	       IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d291 } ;
  assign IF_adder_subractor_rg_sub_THEN_theResult___snd_ETC__q1 =
	     adder_subractor_rg_sub ?
	       _theResult___snd__h7262 :
	       _theResult___snd__h8269 ;
  assign _theResult___snd__h7262 =
	     adder_subractor_fas_0$difference ? 32'd1 : 32'd0 ;
  assign _theResult___snd__h8269 = adder_subractor_fas_0$sum ? 32'd1 : 32'd0 ;
  assign x__h15758 =
	     { adder_subractor_rg_sub ?
		 adder_subractor_fas_31$difference :
		 adder_subractor_fas_31$sum,
		 ...
		 adder_subractor_fas_30$difference :
		 adder_subractor_fas_30$sum,
	       IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d292 } ;
  assign x__h23966 = { 1'd0, rg_ip[63:33] } ;
  assign x__h23973 = { rg_ip[30:0], 1'd0 } ;
  assign x__h24081 = { {16{inp_a[15]}}, inp_a } ;
  assign x__h24088 = { {16{inp_b[15]}}, inp_b } ;
  assign x_carry_burrow__h6168 =
	     (adder_subractor_rg_sub &&
	      adder_subractor_rg_ip[63:32] > adder_subractor_rg_ip[31:0]) ?
	       ~IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d171 :
	       IF_adder_subractor_rg_sub_THEN_adder_subractor_ETC___d171 ;
  assign x_sum_difference__h6169 = { 1'd0, x__h15758 } ;
  ...
  begin
	...
	adder_subractor_opReady <= `BSV_ASSIGNMENT_DELAY 1'd0;
	adder_subractor_rg_ip <= `BSV_ASSIGNMENT_DELAY 64'd0;
	adder_subractor_rg_op <= `BSV_ASSIGNMENT_DELAY 34'd0;
	adder_subractor_rg_sub <= `BSV_ASSIGNMENT_DELAY 1'd0;
	counter <= `BSV_ASSIGNMENT_DELAY 7'd0;
	got_ip <= `BSV_ASSIGNMENT_DELAY 1'd0;
	got_partop <= `BSV_ASSIGNMENT_DELAY 1'd0;
	rg_ip <= `BSV_ASSIGNMENT_DELAY 64'd0;
	...
	if (adder_subractor_opReady$EN)
	  adder_subractor_opReady <= `BSV_ASSIGNMENT_DELAY
	      adder_subractor_opReady$D_IN;
	if (adder_subractor_rg_ip$EN)
	  adder_subractor_rg_ip <= `BSV_ASSIGNMENT_DELAY
	      adder_subractor_rg_ip$D_IN;
	if (adder_subractor_rg_op$EN)
	  adder_subractor_rg_op <= `BSV_ASSIGNMENT_DELAY
	      adder_subractor_rg_op$D_IN;
	if (adder_subractor_rg_sub$EN)
	  adder_subractor_rg_sub <= `BSV_ASSIGNMENT_DELAY
	      adder_subractor_rg_sub$D_IN;
	if (counter$EN) counter <= `BSV_ASSIGNMENT_DELAY counter$D_IN;
	if (got_ip$EN) got_ip <= `BSV_ASSIGNMENT_DELAY got_ip$D_IN;
	if (got_partop$EN)
	  got_partop <= `BSV_ASSIGNMENT_DELAY got_partop$D_IN;
	if (rg_ip$EN) rg_ip <= `BSV_ASSIGNMENT_DELAY rg_ip$D_IN;
  ...
  begin
    ...
    adder_subractor_opReady = 1'h0;
    adder_subractor_rg_ip = 64'hAAAAAAAAAAAAAAAA;
    adder_subractor_rg_op = 34'h2AAAAAAAA;
    adder_subractor_rg_sub = 1'h0;
    counter = 7'h2A;
    got_ip = 1'h0;
    got_partop = 1'h0;
    rg_ip = 64'hAAAAAAAAAAAAAAAA;
    rg_op = 32'hAAAAAAAA;
  end
