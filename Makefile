...
DISTRO ?= /home/shakti/Bluespec_BSV_Tutorial
...
BSC_COMP_FLAGS = -elab -keep-fires -aggressive-conditions -no-warn-action-shadowing -show-range-conflict --show-schedule
...
compile: build_bsim
	...
	bsc -steps-max-intervals 20000 -u +RTS -K80M -RTS -sim $(BSIM_DIRS) $(BSC_COMP_FLAGS) -g $(TOPMODULE)  $(TOPFILE) 
